...
def checkSafe(table, i, j, num):
    ...
    return unUsedNum(
        table, i - i % 3, j - j % 3, num
    )  # A nifty trick to avoid index error here, ex - for 0,7, parameter passed to unUsedNum is 0 - 0%3 = 0, 7 - 7%3 = 6 => 0,6, which is the uppermost left side cell we are currently working with
...
def sudokuGridGen():
    ...
    ]  # Should initialize a list of lists with all elements as 0
